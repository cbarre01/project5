...
public class EvilRobot extends Moving {
    ...
    public void executeActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        ...
        {
            infectedTarget = world.findNearest(getPosition(), RobotEmpty.class);
        }
    ...
    public Point nextPosition(WorldModel world,
        ...
        Predicate<Point> canPassThrough = new Predicate<Point>()
        {
            public boolean test(Point p)
            {
                ...
                if (occupant.isPresent() && !(occupant.get() instanceof RobotFull))
                {
                    return false;
                }
                return true;
    ...
    public static EvilRobot createEvilRobot(String id, int resourceLimit,
                                            ...
                                            List<PImage> images)
    {
        return new EvilRobot(id, position, images,
